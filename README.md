...
Replace `assets/images/profile.jpg` with your own photo, keeping the same filename. A square image (at least 800x800px) works best since it's cropped into a circle.
